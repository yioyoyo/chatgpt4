...
export default (props: Props) => {
  ...
  return (
    <div id="input_container" class="mt-2 max-w-[450px]">
      <div class="fi mt-12">
        <span class="text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-sky-400 to-emerald-600">AICHATS & GPT4.0</span>
      </div>
      <p mt-1 op-60>
      ...
      <Show when={showCharge()}>
        <div class="mt-4">
          <Show when={!url()}>
            ...
            <span class="text-sm">
              超值月卡活动进行中,请选择充值套餐,字数套餐按<span class="font-extrabold">字数计费(无时间限制,无购买限制)</span>
